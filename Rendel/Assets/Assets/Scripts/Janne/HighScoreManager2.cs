...
public class HighScoreManager2 : MonoBehaviour
{
    ...
    private static HighScoreManager2 m_instance;
    private const int LeaderboardLength = 10;

    public static HighScoreManager2 _instance
    {
        get
        {
            if (m_instance == null)
            {
                m_instance = new GameObject("HighScoreManager").AddComponent<HighScoreManager2>();
            }
            return m_instance;
        }
    }
